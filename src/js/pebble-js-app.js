...
function fetchCgmData(lastReadTime, lastBG) {
    ...
    req.open('GET', "http://jasper4242.azurewebsites.net/pebble", true); //edit name below in message
    var req2 = new XMLHttpRequest();
    req2.open('GET', "http://jasmine4242.azurewebsites.net/pebble", true); // edit name below in message 
